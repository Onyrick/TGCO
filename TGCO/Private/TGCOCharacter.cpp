...
void ATGCOCharacter::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	...
	InputComponent->BindTouch(EInputEvent::IE_Pressed, this, &ATGCOCharacter::TouchStarted);
...
void ATGCOCharacter::OnFire()
{
	...
	if (ProjectileClass != NULL)
	{
		...
		if (World != NULL)
		{
			...
			World->SpawnActor<ATGCOProjectile>(ProjectileClass, SpawnLocation, SpawnRotation);
		}
	}
...
void ATGCOCharacter::TouchStarted(const ETouchIndex::Type FingerIndex, const FVector Location)
{
